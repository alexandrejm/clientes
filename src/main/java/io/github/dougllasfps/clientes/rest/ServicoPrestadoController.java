...
@RequiredArgsConstructor // Cria um construtor com os argumentos obrigatórios marcados como "final"9
public class ServicoPrestadoController  {
    ...
    public List<ServicoPrestado> pesquisar(
        ...
        return repository.findByNomeClienteAndMes("%" + nome + "%", mes); // O % pega qualquer coisa antes e depois do nome - *nome*
    }
}
